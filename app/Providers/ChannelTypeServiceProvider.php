...
use App\Support\ChannelTypes\ForumChannelType;
use App\Support\ChannelTypes\HybridConversationType;
use App\Support\ChannelTypes\MessageAndCommentChannelType;
...
class ChannelTypeServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        ChannelTypeRegistry::register(new ForumChannelType());
        ChannelTypeRegistry::register(new MessageAndCommentChannelType());
    }
}
