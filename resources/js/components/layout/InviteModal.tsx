            ...
            >
                ...
                <div className="flex gap-2 mb-5">
                    <input
                        ...
                        className="flex-1 bg-surface-800 border border-surface-400 rounded px-3 py-2 text-sm text-text-muted"
                    />
                    <button
                        onClick={copyLink}
                        className="px-4 py-2 rounded bg-surface-500 hover:bg-surface-400 text-text-secondary text-sm font-medium transition-colors duration-100 flex-shrink-0"
                    >
                        {copied ? 'Copied!' : 'Copy'}
                    </button>
                </div>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={send}
                        disabled={busy}
                        className="px-4 py-2 rounded bg-brand hover:bg-brand-hover text-white text-sm font-medium transition-colors duration-100 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {busy ? 'Sending…' : 'Invite'}
                    </button>
                </div>
                ...
                <button
                    onClick={onClose}
                    className="w-full mt-5 px-4 py-2 rounded bg-surface-500 hover:bg-surface-400 text-text-secondary text-sm font-medium transition-colors duration-100"
                >
                    Done
                </button>
            </div>
