...
export function AudioSettings() {
    ...
    return (
        <div className="space-y-5">
            <div className="bg-second rounded-lg p-6 space-y-5">
                {!labelsUnlocked && (
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className="flex-shrink-0 rounded bg-accent-primary hover:bg-accent-secondary px-3 py-1.5 text-sm font-medium text-inverse transition-colors duration-100"
                        >
                            Grant Access
                        </button>
                    </div>
            ...
            <div className="bg-second rounded-lg p-6 space-y-4">
                <div>
            ...
            <div className="bg-second rounded-lg p-6 space-y-3">
                <div className="flex items-center justify-between gap-4">
                    <div>
                ...
                <div
                    ...
                    aria-valuemin={0}
                    aria-valuemax={100}
                    className="relative h-2 w-full rounded-full bg-fifth overflow-hidden"
                >
                    <div
                ...
                <div className="pt-1">
                    ...
                    <input
                        ...
                        className="w-full accent-[rgb(var(--color-accent-primary))] disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                </div>
                ...
                <div className="pt-1">
                    ...
                    <select
                        ...
                        className="w-full bg-third border border-sixth rounded px-3 py-2 text-sm text-text-primary focus:outline-none focus:border-accent-primary transition-colors duration-100 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
