                        ...
                        tabs={[
                            {
                                ...
                                content: (
                                    <>
                                        {/* Live preview */}
                                        <div className="bg-second rounded-lg p-6 mb-6 flex items-center gap-4">
                                            <Avatar
                                        ...
                                        <div className="bg-second rounded-lg p-6 space-y-5">
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    rows={3}
                                                    maxLength={190}
                                                    className="w-full bg-third border border-sixth rounded px-3 py-2 text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent-primary transition-colors duration-100 resize-none"
                                                />
