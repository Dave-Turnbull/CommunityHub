        ...
        <>
            ...
            <div className="min-h-screen grid place-items-center bg-surface-900 px-4 py-12">
                <div className="w-full max-w-md">
                    {invalid ? (
                        <div className="bg-surface-700 rounded-lg p-8 shadow-2xl text-center">
                            ...
                            <a
                                href="/"
                                className="inline-block px-4 py-2 rounded bg-brand hover:bg-brand-hover text-white text-sm font-medium transition-colors duration-100"
                            >
                                Go home
                            </a>
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            readOnly
                                            className="w-full bg-surface-800 border border-surface-400 rounded px-3 py-2 text-sm text-text-muted"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-semibold uppercase tracking-wide text-text-secondary mb-1.5">
