...
import { createRole, deleteRole, reorderRoles } from '@/services/api'
import type { Role, RoomRolesPageProps } from '@/types'
                ...
                <main className="flex-1 min-h-0 overflow-y-auto bg-primary px-6 py-6">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-sm text-text-muted mb-6">
                            ...
                            from the Roles tab in <Link href="/settings" className="underline hover:text-text-primary">Settings</Link> (server admins only).
                        </p>
                        ...
                        {sorted.map((role) => {
                            ...
                            return (
                                <RoleCard
                                    ...
                                    onMemberChanged={() => router.reload({ only: ['room'] })}
                                />
                            )
                        })}
                    </div>
